        ...
        private static function registerGetInfo( AbilityRegistry $abilities, ToolRegistry $tools ): void {
                $abilities->register( Ability::make(
                        array(
                                ...
                                'inputSchema' => array( 'type' => 'object', 'properties' => (object) array(), 'additionalProperties' => false ),
                                'level'       => 0,
                ...
                $abilities->register( Ability::make(
                        array(
                                ...
                                'inputSchema' => array(
                                        'type'       => 'object',
                                        'properties' => array(
                                                'theme' => array( 'type' => 'string', 'maxLength' => 100, 'description' => 'Theme slug. Defaults to the active theme.' ),
                                                'path'  => array( 'type' => 'string', 'maxLength' => 200, 'description' => 'Optional subdirectory, e.g. "template-parts".' ),
                                        ),
                ...
                $tools->register( Tool::make(
                        array(
                                ...
                                'inputSchema'     => array(
                                        'type'       => 'object',
                                        'properties' => array(
                                                'theme' => array( 'type' => 'string', 'maxLength' => 100 ),
                                                'path'  => array( 'type' => 'string', 'maxLength' => 200 ),
                                        ),
                                        'additionalProperties' => false,
                                ),
                                'riskLevel'       => 0,
                ...
                $abilities->register( Ability::make(
                        array(
                                ...
                                'inputSchema' => array(
                                        'type'       => 'object',
                                        'properties' => array(
                                                'file'  => array( 'type' => 'string', 'maxLength' => 300, 'description' => 'Theme-relative path, e.g. functions.php or template-parts/header.php' ),
                                                'theme' => array( 'type' => 'string', 'maxLength' => 100, 'description' => 'Theme slug. Defaults to active theme.' ),
                                        ),
                                        'required'   => array( 'file' ),
                                        'additionalProperties' => false,
                                ),
                ...
                $tools->register( Tool::make(
                        array(
                                ...
                                'inputSchema'     => array(
                                        'type'       => 'object',
                                        'properties' => array(
                                                'file'  => array( 'type' => 'string', 'maxLength' => 300 ),
                                                'theme' => array( 'type' => 'string', 'maxLength' => 100 ),
                                        ),
                                        'required'   => array( 'file' ),
                                        'additionalProperties' => false,
