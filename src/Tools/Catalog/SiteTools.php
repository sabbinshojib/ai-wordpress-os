				...
				'executeCallback' => static function ( array $args, $user ): AbilityResult {
					...
					return AbilityResult::success(
						array(
							...
							'php_sapi'        => PHP_SAPI,
							'php_extensions'  => array_values( array_intersect( get_loaded_extensions(), array(
								'curl', 'mbstring', 'openssl', 'imagick', 'gd', 'zip', 'intl', 'sodium', 'opcache', 'redis', 'memcached',
							) ) ),
							'memory_limit'    => ini_get( 'memory_limit' ) ?: 'unknown',
							'max_execution'   => (int) ( ini_get( 'max_execution_time' ) ?: 0 ),
