...
final class DatabaseTest extends TestCase {
        ...
        public function test_migration_generates_all_tables(): void {
                ...
                $this->assertEquals( array( '202501010001', '202509060001', '202509060002', '202509070001' ), $result['applied'] );
                $this->assertEquals( array( '202501010001', '202509060001', '202509060002', '202509070001' ), $migrator->appliedVersions() );
                $this->assertTrue( $migrator->isUpToDate() );
        }

        public function test_migration_is_idempotent(): void {
                update_option( 'ai_os_migrations', array( '202501010001', '202509060001', '202509060002', '202509070001' ) );
                $migrator = new Migrator();
